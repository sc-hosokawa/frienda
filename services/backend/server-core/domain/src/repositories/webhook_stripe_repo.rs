...
pub trait WebhookStripeRepository {
    async fn create(&self, webhook_stripe: WebhookStripe) -> Result<WebhookStripe, DomainError>;
    ...
    async fn update(&self, webhook_stripe: WebhookStripe) -> Result<WebhookStripe, DomainError>;
