...
pub trait PurchaseHistoryRepository {
    async fn create(&self, purchase: PurchaseHistory) -> Result<PurchaseHistory, DomainError>;
    ...
    async fn update(&self, purchase: PurchaseHistory) -> Result<PurchaseHistory, DomainError>;
}
