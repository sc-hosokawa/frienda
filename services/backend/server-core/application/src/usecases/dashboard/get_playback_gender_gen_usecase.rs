...
impl GetPlaybackGenderGenUsecaseTrait for GetPlaybackGenderGenUsecase {
    async fn get_playback_gender_gen(
        ...
        let gender_gen_playback: Vec<GenderGenPlayback> = match (input.upc, input.isrc) {
            (Some(upc), _) => {
                // UPCが指定された場合
                let product_track: Vec<ProductTrack> =
                    self.product_track_repo.get_by_upc(&upc).await?;
                let isrcs_in_upc: Vec<String> = product_track
                    .iter()
                    .map(|p| p.isrc.clone())
                    .collect::<Vec<String>>();
                self.gender_gen_playback_repo
        ...
        // Gender Balance
        let male_count: i32 = gender_gen_playback
            .iter()
        ...
        let female_count: i32 = gender_gen_playback
            .iter()
        ...
        let neutral_count: i32 = gender_gen_playback
            .iter()
        ...
        let unknown_gender_count: i32 = gender_gen_playback
            .iter()
        ...
        // Generation Balance
        let under_17_count: i32 = gender_gen_playback
            .iter()
        ...
        let _18_22_count: i32 = gender_gen_playback
            .iter()
        ...
        let _23_27_count: i32 = gender_gen_playback
            .iter()
        ...
        let _28_34_count: i32 = gender_gen_playback
            .iter()
        ...
        let _35_44_count: i32 = gender_gen_playback
            .iter()
        ...
        let _45_59_count: i32 = gender_gen_playback
            .iter()
        ...
        let _60_150_count: i32 = gender_gen_playback
            .iter()
