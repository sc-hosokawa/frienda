use crate::test_support::mocks::quest_mock::MockMockQuestsRepo;
use crate::test_support::mocks::quest_user_mock::MockMockQuestUserRepo;
use crate::usecases::quest::get_quests_usecase::{GetQuestsUsecase, GetQuestsUsecaseTrait};
