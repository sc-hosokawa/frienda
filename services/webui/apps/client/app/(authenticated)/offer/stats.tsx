      ...
      <div className="space-y-4 bg-[#1C1C1C] p-8 rounded-2xl">
        <div className="grid grid-cols-2 gap-4">
          <div className="flex items-center justify-between w-full border-b border-dotted border-white/30 pb-4">
            ...
            <p className="text-7xl font-extralight">{stats.totalOffers}</p>
          </div>
          <div className="flex items-center justify-between w-full border-b border-dotted border-white/30 pb-4">
            <div className="flex items-center">
            ...
            <p className="text-7xl font-extralight">{stats.ongoingOffers}</p>
          </div>
        </div>
        <div className="grid grid-cols-2 gap-4">
          <div className="flex items-center justify-between w-full border-b border-dotted border-white/30 pb-4">
            ...
            <p className="text-7xl font-extralight">{stats.appliedOffers}</p>
          </div>
          <div className="flex items-center justify-between w-full border-b border-dotted border-white/30 pb-4">
            <div className="flex items-center">
            ...
            <p className="text-7xl font-extralight">{stats.completedOffers}</p>
          </div>
        </div>
        <div className="flex items-center justify-between border-b border-dotted border-white/30 pt-4">
          ...
          <p className="text-7xl font-extralight">{stats.totalEarnings}</p>
        </div>
      </div>
    </div>
  );
