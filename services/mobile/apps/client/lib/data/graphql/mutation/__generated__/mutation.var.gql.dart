...
abstract class GUpdateOfferStatusVars
    implements Built<GUpdateOfferStatusVars, GUpdateOfferStatusVarsBuilder> {
  GUpdateOfferStatusVars._();

  factory GUpdateOfferStatusVars(
          [void Function(GUpdateOfferStatusVarsBuilder b) updates]) =
      _$GUpdateOfferStatusVars;

  _i1.GUpdateOfferStatusInput get input;
  static Serializer<GUpdateOfferStatusVars> get serializer =>
      _$gUpdateOfferStatusVarsSerializer;

  Map<String, dynamic> toJson() => (_i2.serializers.serializeWith(
        GUpdateOfferStatusVars.serializer,
        this,
      ) as Map<String, dynamic>);

  static GUpdateOfferStatusVars? fromJson(Map<String, dynamic> json) =>
      _i2.serializers.deserializeWith(
        GUpdateOfferStatusVars.serializer,
        json,
      );
...
abstract class GCreateBulkFspTxVars
    implements Built<GCreateBulkFspTxVars, GCreateBulkFspTxVarsBuilder> {
  GCreateBulkFspTxVars._();

  factory GCreateBulkFspTxVars(
          [void Function(GCreateBulkFspTxVarsBuilder b) updates]) =
      _$GCreateBulkFspTxVars;

  BuiltList<_i1.GCreateNewTransactionInput> get input;
  static Serializer<GCreateBulkFspTxVars> get serializer =>
      _$gCreateBulkFspTxVarsSerializer;

  Map<String, dynamic> toJson() => (_i2.serializers.serializeWith(
        GCreateBulkFspTxVars.serializer,
        this,
      ) as Map<String, dynamic>);

  static GCreateBulkFspTxVars? fromJson(Map<String, dynamic> json) =>
      _i2.serializers.deserializeWith(
        GCreateBulkFspTxVars.serializer,
        json,
      );
...
abstract class GCreatePrizeVars
    implements Built<GCreatePrizeVars, GCreatePrizeVarsBuilder> {
  GCreatePrizeVars._();

  factory GCreatePrizeVars([void Function(GCreatePrizeVarsBuilder b) updates]) =
      _$GCreatePrizeVars;

  _i1.GCreateNewPrizeInput get input;
  static Serializer<GCreatePrizeVars> get serializer =>
      _$gCreatePrizeVarsSerializer;

  Map<String, dynamic> toJson() => (_i2.serializers.serializeWith(
        GCreatePrizeVars.serializer,
        this,
      ) as Map<String, dynamic>);

  static GCreatePrizeVars? fromJson(Map<String, dynamic> json) =>
      _i2.serializers.deserializeWith(
        GCreatePrizeVars.serializer,
        json,
      );
...
abstract class GExchangePrizeVars
    implements Built<GExchangePrizeVars, GExchangePrizeVarsBuilder> {
  GExchangePrizeVars._();

  factory GExchangePrizeVars(
          [void Function(GExchangePrizeVarsBuilder b) updates]) =
      _$GExchangePrizeVars;

  _i1.GExchangePrizeInput get input;
  static Serializer<GExchangePrizeVars> get serializer =>
      _$gExchangePrizeVarsSerializer;

  Map<String, dynamic> toJson() => (_i2.serializers.serializeWith(
        GExchangePrizeVars.serializer,
        this,
      ) as Map<String, dynamic>);

  static GExchangePrizeVars? fromJson(Map<String, dynamic> json) =>
      _i2.serializers.deserializeWith(
        GExchangePrizeVars.serializer,
        json,
      );
